  ...
  systemd.services.fan-curve = {
    ...
    script = ''
      ...
      for pwm in 2 3; do
        ...
        echo 40000 > "$NCT/pwm''${pwm}_auto_point1_temp"
        echo 0     > "$NCT/pwm''${pwm}_auto_point1_pwm"
        echo 45000 > "$NCT/pwm''${pwm}_auto_point2_temp"
        echo 64    > "$NCT/pwm''${pwm}_auto_point2_pwm"
        echo 55000 > "$NCT/pwm''${pwm}_auto_point3_temp"
        echo 115   > "$NCT/pwm''${pwm}_auto_point3_pwm"
        echo 65000 > "$NCT/pwm''${pwm}_auto_point4_temp"
        echo 178   > "$NCT/pwm''${pwm}_auto_point4_pwm"
        echo 75000 > "$NCT/pwm''${pwm}_auto_point5_temp"
